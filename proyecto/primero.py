...
def activation(name, x):
    ...
    if name == "relu":     # ReLU: rectificador (valores negativos a 0)
        return max(0, x)
    if name == "tanh":     # Tangente hiperbólica: valores entre -1 y 1
        return math.tanh(x)
...
# ================================
# 3. Dataset: AND lógico
# ================================
# Entradas (dos valores binarios) y salidas esperadas
X = [[0,0], [0,1], [1,0], [1,1]]
y = [0, 0, 0, 1]  # Solo 1 cuando ambas entradas son 1
